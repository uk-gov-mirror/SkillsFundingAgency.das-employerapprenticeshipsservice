...
Scenario: Sceanrio-01-Late-submissions
	...
	Then user Dave from account A should see a level 1 screen with a balance of 132000 on the 04/2017
	And user Dave from account A should see a level 1 screen with a total levy of 11000 on the 06/2017
	And user Dave from account A should see a level 1 screen with a total levy of 11000 on the 02/2018
	And user Dave from account A should see a level 2 screen with a levy declared of 10000 on the 02/2018
	And user Dave from account A should see a level 2 screen with a top up of 1000 on the 02/2018
