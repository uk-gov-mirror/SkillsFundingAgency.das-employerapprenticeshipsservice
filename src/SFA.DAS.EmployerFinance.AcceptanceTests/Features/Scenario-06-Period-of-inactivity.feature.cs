...
#line 16
 testRunner.Then("user Dave from account A should see a level 1 screen with a balance of 63250 on t" +
                    "he 12/2017", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line 17
 testRunner.And("user Dave from account A should see a level 1 screen with a total levy of 8250 on" +
                    " the 11/2017", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 18
 testRunner.And("user Dave from account A should see a level 2 screen with a levy declared of 7500" +
                    " on the 11/2017", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 19
 testRunner.And("user Dave from account A should see a level 2 screen with a top up of 750 on the " +
                    "11/2017", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
