...
Scenario: Sceanrio-01-Inactivity-period
	...
	Then user Dave from account A should see a level 1 screen with a balance of 63250 on the 12/2017
	And user Dave from account A should see a level 1 screen with a total levy of 8250 on the 11/2017
	And user Dave from account A should see a level 2 screen with a levy declared of 7500 on the 11/2017
	And user Dave from account A should see a level 2 screen with a top up of 750 on the 11/2017
