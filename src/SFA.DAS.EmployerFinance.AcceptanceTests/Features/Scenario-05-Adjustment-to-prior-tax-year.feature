...
Scenario: Sceanrio-01-End-of-year-adjustment
	...
	When we refresh levy data for account A paye scheme 123/ABC
	And All the transaction lines in this scenario have had there transaction date updated to the specified created date
	Then user Dave from account A should see a level 1 screen with a balance of 154000 on the 06/2018
	And user Dave from account A should see a level 1 screen with a total levy of -5500 on the 06/2018
	And user Dave from account A should see a level 2 screen with a levy declared of -5000 on the 06/2018
	And user Dave from account A should see a level 2 screen with a top up of -500 on the 06/2018
